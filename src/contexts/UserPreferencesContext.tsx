...
export function UserPreferencesProvider({
 ...
 [userProfile, state.preferences.notifications]
 );
 ...
 [userProfile, state.preferences.privacy]
 );
 ...
 [userProfile, state.preferences.playback]
 );
 ...
 }, [userProfile, authLoading, cachePreferences, clearCache]);
