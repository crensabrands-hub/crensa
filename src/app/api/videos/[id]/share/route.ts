...
export async function POST(
    ...
    try {
        ...
        // Use production URL for share links (crensa.com) while keeping localhost for dev
        const shareBaseUrl = process.env.NEXT_PUBLIC_SHARE_URL || 'https://crensa.com'
        const shareUrl = `${shareBaseUrl}/watch/${shareToken}`
