...
function CreatorSupportContent() {
 ...
 <a href="/creator/resources" className="card hover:shadow-lg transition-shadow cursor-pointer">
 ...
 <a href="/creator/guidelines" className="card hover:shadow-lg transition-shadow cursor-pointer">
 ...
 <a href="/creator/analytics" className="card hover:shadow-lg transition-shadow cursor-pointer">
