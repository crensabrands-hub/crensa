...
function CreatorHelpContent() {
 ...
 setSubmitStatus({
 type: "success",
 message: `Your help request has been sent successfully! We'll get back to you within ${
 ...
 className={`group p-4 rounded-xl border-2 text-left transition-all duration-200 hover:shadow-lg hover:-translate-y-1 ${
