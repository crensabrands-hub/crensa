...
import { CreatorFollowButton, CreatorFollowProvider, CreatorStatsGrid } from '@/components/creator/CreatorFollowControls';
...
export default async function CreatorProfilePage({
    ...
    return (
        <CreatorFollowProvider
            creatorId={creatorData.id}
            creatorUsername={creatorData.username}
            initialIsFollowing={initialIsFollowing}
            initialFollowerCount={creatorData.followerCount}
        >
