...
function CreatorResourcesContent() {
 ...
 <a href="/creator/dashboard" className="btn-outline text-center">
 Creator Dashboard
 </a>
 <a href="/creator/analytics" className="btn-outline text-center">
 Analytics
 </a>
 <a href="/creator/earnings" className="btn-outline text-center">
 Earnings & Payouts
 </a>
 </div>
 </div>
 ...
 <a href="/creator/support" className="btn-primary">
 Contact Creator Support
 </a>
 <a href="/creator/guidelines" className="btn-outline">
