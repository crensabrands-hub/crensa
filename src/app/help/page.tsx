...
export default function HelpPage() {
 ...
 <svg
 className={`w-5 h-5 text-neutral-dark-gray transition-transform duration-200 ${
 ...
 <p className="text-sm text-neutral-dark-gray">Manage your credits and payments</p>
 </div>
 </Link>
 </div>
 </div>
