...
export default function VideoGrid({
 ...
 <div className="h-3 sm:h-4 bg-neutral-light-gray rounded w-3/4"></div>
 <div className="h-2 sm:h-3 bg-neutral-light-gray rounded w-1/2"></div>
 <div className="h-2 sm:h-3 bg-neutral-light-gray rounded w-2/3"></div>
 </div>
 </div>
 ))}
 </div>
