...
export function GracefulDegradation({
    ...
    const attemptFeatureRestore = useCallback(() => {
    ...
    }, [featureState.retryCount, maxRetries, featureName, onFeatureRestore]);
    ...
    }, [enableRetry, featureState.retryCount, maxRetries, retryDelay, onFeatureFailure, attemptFeatureRestore]);
