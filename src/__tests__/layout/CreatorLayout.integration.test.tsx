...
function MockCreatorLayout({ children }: { children: React.ReactNode }) {
 ...
 <li>
 <a href="/creator/dashboard" className="block p-2 rounded hover:bg-neutral-gray">
 Dashboard
 </a>
 </li>
 <li>
 <a href="/creator/upload" className="block p-2 rounded hover:bg-neutral-gray">
 Upload Video
 </a>
 </li>
 <li>
 <a href="/creator/analytics" className="block p-2 rounded hover:bg-neutral-gray">
 Analytics
 </a>
 </li>
 </ul>
