    ...
    return (
        <div>
            ...
            <aside
                ...
                className={`fixed top-0 left-0 z-50 h-full bg-white shadow-xl transition-transform duration-300 ${layout.navigation.sidebarOpen ? 'translate-x-0' : '-translate-x-full'
                    } w-64`}
            >
                <div className="p-4">
